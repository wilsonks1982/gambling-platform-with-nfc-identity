...
const GameHistoryTableRoulette = () => {
  ...
  const [isWinList, setIsWinList] = useState(false);
        ...
        <table style={tableStyles.table}>
          ...
          <tbody>
            {paginatedData.map((item, i) => (
              ...
              >
                <td style={tableStyles.thtd}>{item.id}</td>
                <td style={tableStyles.thtd}>{item.egmId}</td>
                <td style={tableStyles.thtd}>{'***' + item.uid.slice(3)}</td>
                <td style={tableStyles.thtd}>
                  {formatToIndianCurrency(item.wallet)}
                </td>
                <td style={tableStyles.thtd}>{item.spinNumber}</td>
                <td
                  style={{
                    ...tableStyles.thtd,
                    color: 'blue',
                ...
                <td style={tableStyles.thtd}>{item.number}</td>
                <td style={tableStyles.thtd}>{item.spinStart}</td>
                <td style={tableStyles.thtd}>{item.spinEnd}</td>
              </MotionTr>
            ))}
          </tbody>
        </table>
...
export default GameHistoryTableRoulette;
