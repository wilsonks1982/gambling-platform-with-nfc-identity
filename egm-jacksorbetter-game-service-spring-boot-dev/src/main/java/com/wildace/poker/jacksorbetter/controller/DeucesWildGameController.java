 ...
 * |  28/07/2025   | Wilson Sam   |   Updated Logic |  Multi-hand support & extended DTOs for deal/draw
 * |  30/07/2025   | Wilson Sam   |   Documentation |  Swagger Documentation for clarity, maintainability, and REST best practices
 * |  30/07/2025   | Wilson Sam   |   Updated       |  Added game results endpoints
 * **********************************************************************************************************************************************************************
 * */
...
import com.wildace.poker.jacksorbetter.service.DeucesWildGameService;
...
@Tag(
    name = "Deuces Wild Game API",
    description = "REST endpoints for Deuces Wild Video Poker game. Includes deal, draw and result retrieval operations."
)
@RestController
@RequestMapping("/api/v1/deuceswild/game")
public class DeucesWildGameController {

    private final DeucesWildGameService gameService;

    @Autowired
    public DeucesWildGameController(DeucesWildGameService gameService) {
     ...
     */
    @Operation(
        summary = "Start a new deal for Deuces Wild Video Poker",
     ...
     */
    @Operation(
        summary = "Get all game results for Deuces Wild Video Poker",
