 ...
 * |  29/07/2025   | Wilson Sam   |   Updated Logic |  Added CRUD operations for pay tables
...
import com.wildace.poker.jacksorbetter.service.DeucesWildPayTableService;
...
@Tag(name = "Deuces Wild PayTable API", description = "Operations related to pay tables for Deuces Wild Poker Game")
@RestController
@RequestMapping("/api/v1/deuceswild/paytable")
public class DeucesWildPayTableController {
    private final DeucesWildPayTableService payTableService;

    public DeucesWildPayTableController(DeucesWildPayTableService payTableService) {
