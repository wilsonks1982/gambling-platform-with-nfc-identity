 ...
 * |  28/07/2025   | Wilson Sam   |     Updated     |  Added method to save pay table document
 * |  28/07/2025   | Wilson Sam   |     Updated     |  Added method to fetch all pay tables
 * |  28/07/2025   | Wilson Sam   |     Updated     |  Added method to fetch pay table by ID
 * |  28/07/2025   | Wilson Sam   |     Updated     |  Added method to delete pay table document
 * |  29/07/2025   | Wilson Sam   |     Updated     |  Added @PostConstruct annotation to initPayTable method
 * |  29/07/2025   | Wilson Sam   |     Updated     |  Added initPayTable method to initialize default pay table
 * |  29/07/2025   | Wilson Sam   |     Updated     |  Added JSON string for default pay table
 * |  29/07/2025   | Wilson Sam   |     Updated     |  Added ObjectMapper to convert JSON to PayTableDocument
 * |  29/07/2025   | Wilson Sam   |     Updated     |  Added check to avoid re-initialization if pay table already exists
...
import com.wildace.poker.deuceswild.model.PayTableDocument;
import com.wildace.poker.deuceswild.model.PayTableHand;
import com.wildace.poker.jacksorbetter.repository.DeucesWildPayTableDocumentRepository;
...
@Service
public class DeucesWildPayTableService {
    private static final Logger logger = LoggerFactory.getLogger(DeucesWildPayTableService.class);
    private static final String PAY_TABLE_DOCUMENT_JSON = """
			{
			    ...
			    "payouts": [
			        {
			            "id": 1,
			            "name": "Natural Royal Flush",
			            "payouts": [250, 500, 750, 1000, 4000]
			        },
			        {
			            "id": 2,
			            "name": "Four Deuces",
			            "payouts": [200, 400, 600, 800, 1000]
			        },
			        {
			            "id": 3,
			            "name": "Wild Royal Flush",
			            "payouts": [25, 50, 75, 100, 125]
			        },
			        {
			            "id": 4,
			            "name": "Five of a Kind",
			            "payouts": [15, 30, 45, 60, 75]
			        },
			        {
			            "id": 5,
			            "name": "Straight Flush",
    ...
    private final DeucesWildPayTableDocumentRepository payTableDocumentRepository;

    public DeucesWildPayTableService(DeucesWildPayTableDocumentRepository payTableDocumentRepository) {
