...
public class PlayerWebSocketHandler extends TextWebSocketHandler {
    ...
    public void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
        logger.info("Player WebSocket received message: {}", message.getPayload());
        // Handle player-specific WebSocket logic here
        session.sendMessage(new TextMessage("Player response: " + message.getPayload()));
    }
}
